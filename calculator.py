...
# creating widgets
db = Entry(mw, width=20, font=('Arial', 28), justify=RIGHT)
...
btn_div = Button(mw, text='/', padx=38, pady=10, font=('Arial', 14), command=lambda: calcu('div'))
btn_mul = Button(mw, text='*', padx=38, pady=10, font=('Arial', 14), command=lambda: calcu('mul'))
btn_sub = Button(mw, text='-', padx=38, pady=10, font=('Arial', 14), command=lambda: calcu('sub'))
btn_add = Button(mw, text='+', padx=36, pady=10, font=('Arial', 14), command=lambda: calcu('add'))
